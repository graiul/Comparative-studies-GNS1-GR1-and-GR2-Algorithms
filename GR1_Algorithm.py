...
class GR1_Algorithm(object):
    ...
    # def producer(queue_of_the_producer, query_parts, query_stwig_1_dict, data_graph_edges, node_attributes_dictionary):
        ...
        # ACEASTA E RAMURA CARE AM FOLOSIT-O IN TESTE.
    ...
    # ############################ Din GNS1_Backtracking_STwig_Matching_with_txt_file_printing ##########################################################
        ...
        # Pentru GR1 Algorithm cu datele lui
        query_stwig_root_node = self.query_graph[0]
        query_stwig_root_node_label = self.query_graph[0][1]

        # Pentru GR1 Algorithm cu datele de la GR2 Algorithm
        # query_stwig_root_node = self.query_graph
        # query_stwig_root_node_label = self.query_graph[1]
        ...
        if number_of_consumers == 1:
            ...
            d = client.submit(self.consumer, queue_of_finished_products_2, queue_of_finished_products_3,
                              query_stwig_leaf_node_label3, query_stwig_length, self.data_graph[0], self.data_graph[1],
                              queue_for_printing)
            ...
            e = client.submit(self.consumer, queue_of_finished_products_3, queue_of_finished_products_4,
                              query_stwig_leaf_node_label4, query_stwig_length, self.data_graph[0], self.data_graph[1],
                              queue_for_printing)
            # print(e)
            # print(e.result())
            # queue_of_futures.put(e)
            ...
            query_stwig_leaf_node5 = self.query_graph[5]
            query_stwig_leaf_node_label5 = self.query_graph[5][1]
            f = client.submit(self.consumer, queue_of_finished_products_4, queue_of_finished_products_5,
                              query_stwig_leaf_node_label5, query_stwig_length, self.data_graph[0], self.data_graph[1],
                              queue_for_printing)

            query_stwig_leaf_node6 = self.query_graph[6]
            query_stwig_leaf_node_label6 = self.query_graph[6][1]
            g = client.submit(self.consumer, queue_of_finished_products_5, queue_of_finished_products_6,
                              query_stwig_leaf_node_label6, query_stwig_length, self.data_graph[0], self.data_graph[1],
                              queue_for_printing)
            g.result()
        else:
